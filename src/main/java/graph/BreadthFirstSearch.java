 ...
 * the vertices that can reach from s by following two edges, then we check for
 * v among all the vertices that we can reach from s by following two edges and
 * so forth.
 */
